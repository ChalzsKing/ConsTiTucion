...
export const GoogleIcon = () => (
    <svg className="w-5 h-5" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
      <path fill="currentColor" d="M488 261.8C488 403.3 381.5 512 244 512 111.8 512 0 400.2 0 261.8 0 123.8 111.8 13.8 244 13.8c72.1 0 124.9 29.5 162.3 63.8L348.4 128C317.1 99.8 283.7 80 244 80c-82.2 0-148.2 66.6-148.2 148.2s66 148.2 148.2 148.2c86.3 0 123.8-55.8 128.8-93.8H244v-75.2h243.6c2.6 14.7 3.8 30.1 3.8 46.8z"></path>
    </svg>
);
...
export const PlayIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M4.5 5.653c0-1.427 1.529-2.33 2.779-1.643l11.54 6.647c1.295.748 1.295 2.539 0 3.286L7.279 20.99c-1.25.72-2.779-.217-2.779-1.643V5.653Z" clipRule="evenodd" />
  </svg>
);
...
export const LightBulbIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.355a7.5 7.5 0 0 1-3 0m3 0a7.5 7.5 0 0 0-3 0m.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 12.75a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Zm0 0v.75m0-6.75h.008v.008H9.75v-.008Zm4.5.008h.008v.008h-.008v-.008Zm-2.25-4.5h.008v.008h-.008V8.25Zm-3-3.75h.008v.008h-.008V4.5Zm4.5 0h.008v.008h-.008V4.5Z" />
    </svg>
);
...
export const BeakerIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 5.25a5.236 5.236 0 0 1 3.262 3.238l-3.528 2.518c-.146.104-.31.162-.484.162h-6c-.174 0-.338-.058-.484-.162L3.488 8.488A5.236 5.236 0 0 1 6.75 5.25h7.5Zm0 0V4.5a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1